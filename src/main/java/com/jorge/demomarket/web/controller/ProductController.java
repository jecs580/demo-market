...
import com.jorge.demomarket.domain.service.ProductService;
...
@RestController  // Indicamos que esta clase sera un controlador de una API Rest
@RequestMapping("/products") // Especificamos en que ruta va a aceptar las peticiones que le hagamos
public class ProductController {
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "Ok"),
            @ApiResponse(code = 404, message = "Product not fouund")
    })
